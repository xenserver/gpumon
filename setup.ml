...
(* OASIS_START *)
(* DO NOT EDIT (digest: a7a4be9b0f38193ccaba2f7201b2ef2d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_main", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Gpumon_config"; "Nvml"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "gpumon-libs";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "gpumon_libs";
                           FindlibPackage ("threads", None);
                           FindlibPackage ("stdext", None);
                           FindlibPackage ("rrdd-plugin", None);
                           FindlibPackage ("xcp.gpumon", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "gpumon.ml"});
               Executable
                 ({
                     cs_name = "test_main";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\215\220a(\020\173\232b8C\017\182\nwXD";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
