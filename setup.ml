...
(* OASIS_START *)
(* DO NOT EDIT (digest: 16083bba88771398fadc208dd4fba3ba) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Result"; "Gpumon_config"; "Nvml"];
                      lib_pack = false;
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\186\213\140\231n\146\169A\"\016\236j\022\213\rx";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
