...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7bb386849761c0afe2b06fa77af7f6b2) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrdp_gpumon.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\127i\164\252\203=\189x^\026\211is\144#U";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
